 <div class="header-area header-bottom "style="background-color: yellowgreen;">
     <div class="container">
         <div class="row align-items-center">
             <div class="col-lg-9 d-none d-lg-block">
                 <div class="horizontal-menu">
                     <nav>
                         <ul id="nav_menu">
                             <li><a href="{{ route('users.index') }}"><i class="ti-list"></i> <span>User List</span></a></li>
                             <li><a href="{{ route('customers.index') }}"><i class="ti-list"></i> <span>Client List</span></a></li>
                             {{-- <li>
