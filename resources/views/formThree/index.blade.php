            ...
            <div class="card">
                <div class="card card-body" style="border:1px solid teal">
                    ...
                    <form
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="has_eu_branch"
                                    ...
                                    <option value="1"
                                        {{ old('has_eu_branch', $form->has_eu_branch) == 1 ? 'selected' : '' }}>Ja</option>
                                    <option value="0"
                                        {{ old('has_eu_branch', $form->has_eu_branch) == 0 ? 'selected' : '' }}>Nein
                                    </option>
                                </select>
                                @error('has_eu_branch')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="is_pep" class="form-control @error('is_pep') is-invalid @enderror">
                                    <option value="">Bitte wählen</option>
                                    <option value="1" {{ old('is_pep', $form->is_pep) == 1 ? 'selected' : '' }}>Ja
                                    </option>
                                    <option value="0" {{ old('is_pep', $form->is_pep) == 0 ? 'selected' : '' }}>Nein
                                    </option>
                                </select>
                                @error('is_pep')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label>Provision** pro Own-Delivery Bestellung</label>
                                ...
                                @error('fee_own_delivery')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                <label>Provision** pro Lieferung durch Lieferando Bestellung</label>
                                ...
                                @error('fee_platform_delivery')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                <label>Provision** pro Bestellung bei Abholung</label>
                            ...
                            <div class="form-group col-md-4">
                                <label>Online-Zahlungsgebühr pro Bestellung (EUR)</label>
                                ...
                                @error('fee_online_payment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                <label>Kosten für Terminal (EUR)</label>
                            ...
                            <div class="form-group col-md-4">
                                <label>NEU - Banner (zunächst 4 Wochen)</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label>Kosten für Bestellübermittlung</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                @if ($form->signature_file)
                                    <img src="{{ asset('storage/' . $form->signature_file) }}" class="mt-2 img-fluid"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select name="pickup_option"
                                    class="form-control @error('pickup_option') is-invalid @enderror">
                                    <option value="">---</option>
                                    <option value="1"
                                        {{ old('pickup_option', $form->pickup_option) ? 'selected' : '' }}>Ja</option>
                                    <option value="0"
                                        {{ old('pickup_option', $form->pickup_option) === 0 ? 'selected' : '' }}>Nein
                                    </option>
                                </select>
                                @error('pickup_option')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Barzahlung (gilt nur für Own Delivery)</label>
                                <select name="cash_payment"
                                    class="form-control @error('cash_payment') is-invalid @enderror">
                                    <option value="">---</option>
                                    <option value="1"
                                        {{ old('cash_payment', $form->cash_payment) == 1 ? 'selected' : '' }}>Ja</option>
                                    <option value="0"
                                        {{ old('cash_payment', $form->cash_payment) == 0 ? 'selected' : '' }}>Nein</option>
                                </select>
                                @error('cash_payment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-md-3">
                                <label>Teilnahme am Stempelkarten-Programm</label>
                                <select name="stempelkarte_participation"
                                    class="form-control @error('stempelkarte_participation') is-invalid @enderror">
                                    <option value="">---</option>
                                    <option value="1"
                                        {{ old('stempelkarte_participation', $form->stempelkarte_participation) == 1 ? 'selected' : '' }}>
                                        Ja</option>
                                    <option value="0"
                                        {{ old('stempelkarte_participation', $form->stempelkarte_participation) == 0 ? 'selected' : '' }}>
                                        Nein</option>
                                </select>
                                @error('stempelkarte_participation')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                @error('delivery_area_postal_codes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-3">
