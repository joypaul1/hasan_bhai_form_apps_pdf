    ...
    <form class="neukunde">
        <table>
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" id="company_name" name="company_name" value="{{ $form->owner_name }}"></td>
            </tr>
            <tr>
                <th for="billing_address">Rechnungsadresse</th>
                <td colspan="2"><input type="text" id="billing_address" name="billing_address"></td>
            </tr>
            <tr>
            ...
            <tr class="highlight">
                ...
                <td colspan="2"><input type="text" id="bank_details" name="bank_details" value="{{ $form->iban }}"></td>
            </tr>
            <tr class="highlight">
                <th for="vat_id">Umsatzsteuer-ID-Nr.</th>
                <td colspan="2"><input type="text" id="vat_id" name="vat_id" value="{{ $form->vat_id }}"></td>
            </tr>
            <tr class="highlight">
                <th for="tax_number">Steuernummer</th>
                <td colspan="2"><input type="text" id="tax_number" name="tax_number"></td>
            </tr>

            <tr>
                <th for="primary_contact">Hauptansprechpartner</th>
                <td colspan="2"><input type="text" id="primary_contact" name="primary_contact" value="{{ $form->contact_person }}"></td>
            </tr>
            <tr>
                <th for="mobile_number">Handy-Nr.</th>
                <td colspan="2"><input type="tel" id="mobile_number" name="mobile_number" value="{{ $form->mobile_number }}"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><input type="tel" id="landline" name="landline"></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2"><input type="date" id="first_delivery_date" name="first_delivery_date"></td>
            </tr>
            <tr>
                <th for="delivery_contact">Ansprechpartner für Handheld (Lieferabwicklung)</th>
                <td colspan="2"><input type="text" id="delivery_contact" name="delivery_contact"></td>
            </tr>
            <tr>
                <th for="tg_email">e-mail (später für Trans Gourmet)</th>
                <td colspan="2"><input type="email" id="tg_email" name="tg_email"></td>
            </tr>
        </table>
    </form>
</body>
